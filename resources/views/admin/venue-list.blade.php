    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
        <div class="relative z-0 overflow-x-auto">
          <table class="w-full text-left font-sans rtl:text-right" id="venues">
            ...
            <tbody>
              @forelse ($venues as $venue)
                <tr class="even:bg-gray-800 odd:dark:bg-gray-600">
                  ...
                  <td
                    class="whitespace-nowrap font-sans text-white sm:px-2 sm:py-3 sm:text-base md:px-6 md:py-2 md:text-lg lg:px-8 lg:py-4">
                    <a href="{{ route('admin.edit-venues', $venue->id) }}">Edit</a>
              ...
              @empty
                <tr>
                  <td colspan="3" class="text-center text-2xl text-white">No venues found</td>
                </tr>
              @endforelse
            </tbody>
          </table>
