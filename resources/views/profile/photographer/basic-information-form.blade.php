<header>
  <h2 class="text-md font-heading font-medium text-white">
    {{ __('Photographer Details') }}
  </h2>
</header>
<form method="POST" action="{{ route('photographer.update', ['dashboardType' => $dashboardType, 'user' => $user]) }}"
  class="grid grid-cols-3 gap-x-8 gap-y-8" enctype="multipart/form-data">
  @csrf
  @method('PUT')
  <div class="col-start-1 col-end-2">
    <div class="group mb-6">
      <x-input-label-dark for="name">Photography Name</x-input-label-dark>
    ...
    <div class="group mb-6">
      <x-input-label-dark for="photographerName">Contact Name</x-input-label-dark>
